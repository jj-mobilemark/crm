...
const VERBS: Record<string, string> = {
	...
	read_pipeline_report: "Read a pipeline report",
	read_trip_plan: "Read the trip brief",
	search_trip_candidates: "Ranked nearby companies for the trip",
	write_trip_itinerary: "Saved the trip itinerary",
